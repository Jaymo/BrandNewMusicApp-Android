...
public class TrackGArtistfragmentAdapter extends BaseAdapter implements Filterable
{
    ...
    String status;
    public TrackGArtistfragmentAdapter(Activity a, ArrayList<HashMap<String, String>> d) 
    {
        activity = a;
    ...
    public View getView(int position, View convertView, ViewGroup parent) 
    {
       ...
       if(convertView==null){
           ...
           holder.listrow=(RelativeLayout)vi.findViewById(R.id.tracks_listrow);
