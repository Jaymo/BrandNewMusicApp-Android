...
public class GenrefragmentAdapter extends BaseAdapter {
    ...
    public ImageLoader imageLoader; 
     ...
     public GenrefragmentAdapter (Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.genre.setText(hash.get(GenreListFragment.KEY_NAME));
        imageLoader.DisplayImage(hash.get(GenreListFragment.KEY_IMAGE_URL), holder.thumb);
        return vi;
    }
